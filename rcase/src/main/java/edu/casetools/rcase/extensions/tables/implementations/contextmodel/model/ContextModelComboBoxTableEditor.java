...
import edu.casetools.rcase.extensions.tables.implementations.contextmodel.control.ContextModelTableEditorListener;

// TODO: Auto-generated Javadoc
/**
 * The Class DependencyTableEditor.
 */
public class ContextModelComboBoxTableEditor extends JComboBox<String> implements TableCellEditor {
     ...
     *            the model
     */
    public ContextModelComboBoxTableEditor(List<String> comboBoxNames, ContextModelTableModel model) {
	super(new Vector<String>(comboBoxNames));
	addActionListener(new ContextModelTableEditorListener(this, model));
