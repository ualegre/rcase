...
import edu.casetools.rcase.extensions.tables.implementations.traceability.control.TableEditorListener;

// TODO: Auto-generated Javadoc
/**
 * The Class DependencyTableEditor.
 */
public class DependencyTableEditor extends JComboBox<String> implements TableCellEditor {
     ...
     *            the model
     */
    public DependencyTableEditor(List<String> comboBoxNames, DependencyTableModel model) {
	super(new Vector<String>(comboBoxNames));
	addActionListener(new TableEditorListener(this, model));
