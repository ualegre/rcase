 ...
 * 
 */
package edu.casetools.rcase.extensions.tables.implementations.container.model;
...
public class ContainerTableData implements Serializable {
    ...
    protected ArrayList<TableHeaderData> xHeaderList;
    ...
    public List<TableHeaderData> getxHeaderList() {
	return xHeaderList;
    }

    public void setxHeaderList(List<TableHeaderData> xHeaderList) {
	this.xHeaderList = (ArrayList<TableHeaderData>) xHeaderList;
    }
