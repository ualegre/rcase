 ...
 * 
 */
package edu.casetools.rcase.extensions.tables.implementations.traceability.control.dialogs;
...
public class ButtonPanelListener implements ActionListener {
	...
	return TableUtils.getInstance().getStereotypesFromNames(RCaseModule.getInstance(), RCasePeerModule.MODULE_NAME, filteredStereotypeNames);
    }
