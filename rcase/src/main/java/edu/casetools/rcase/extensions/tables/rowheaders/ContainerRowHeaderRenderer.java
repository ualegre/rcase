...
/**
 * The Class ContainerRowHeaderRenderer.
 */
public class ContainerRowHeaderRenderer implements TableCellRenderer {
    JLabel label;
    JTable rowHeadersTable;

    /**
     * Instantiates a new container row header renderer.
     *
     * @param rowHeadersTable the row headers table
     */
    public ContainerRowHeaderRenderer(JTable rowHeadersTable) {
        label = new JLabel();
