 ...
 */
public class ContextNoteTool extends NoteTool {
     ...
     * 
     * @see
     * edu.middlesex.goodies.casesuite.modelio.diagrams.NoteTool#createOwnNote
	...
	return DiagramUtils.getInstance().createNote(model, owner, RCaseTools.TOOL_CONTEXT_NOTE);
    }
