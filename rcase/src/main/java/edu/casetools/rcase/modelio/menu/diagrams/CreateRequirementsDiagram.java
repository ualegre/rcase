 ...
 */
public class CreateRequirementsDiagram extends CreateDiagram {

    /*
     * (non-Javadoc)
     * 
     * @see
     * edu.middlesex.goodies.casesuite.modelio.menu.CreateDiagram#createOwnDiagram
    ...
    protected StaticDiagram createOwnDiagram(List<MObject> selectedElements,
        ...
        String name =
            I18nMessageService
                .getString("Ui.Command.CreateContextRequirementsDiagram.Label");
        StaticDiagram diagram =
            DiagramUtils.getInstance().createDiagram(selectedElements, session,
                name, RCaseStereotypes.STEREOTYPE_DIAGRAM_REQUIREMENTS);
        diagram =
            (StaticDiagram) addStyle(diagram,
                RCaseResources.STYLE_REQUIREMENTS_DIAGRAM);
        return diagram;
    }
