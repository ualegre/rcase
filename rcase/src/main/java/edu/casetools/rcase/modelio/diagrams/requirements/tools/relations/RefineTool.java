...
/**
 * The Class RefineTool is the tool for creating a Refine realtion.
 */
public class RefineTool extends RelationTool {
    ...
    public Dependency createDependency(ModelElement originElement,
        ...
        return DiagramUtils.getInstance().createDependency(originElement,
            targetElement, RCaseStereotypes.STEREOTYPE_REFINE);
    }
