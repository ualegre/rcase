 ...
 * entity.
 */
public class UserProfileFeatureTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.UserProfileFeature");
	return ElementUtils.getInstance().createClass(RCaseModule.getInstance(), adaptElement(element), session, name,
		RCaseStereotypes.STEREOTYPE_USER_PROFILE_FEATURE);
    }
