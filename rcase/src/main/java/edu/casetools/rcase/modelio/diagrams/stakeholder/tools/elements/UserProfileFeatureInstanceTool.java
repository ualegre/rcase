 ...
 * entity.
 */
public class UserProfileFeatureInstanceTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.UserProfileFeatureInstance");
	return ElementUtils.getInstance().createClass(RCaseModule.getInstance(), adaptElement(element), session, name,
		RCaseStereotypes.STEREOTYPE_USER_PROFILE_FEATURE_INSTANCE);
    }
