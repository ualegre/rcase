 ...
 * contextual menu.
 */
public class OpenDependencyTable extends DefaultModuleCommandHandler {
    private DependencyTable tableDialog;

    /**
     * Instantiates a new open dependency table.
     */
    public OpenDependencyTable() {
	super();
	...
	if (null != this.tableDialog)
	    ...
	    this.tableDialog = new DependencyTable();
