 ...
 */
public class CreateUseCase extends CreateElement {
	...
	DiagramUtils.getInstance().createUseCase(selectedElements, session, name, RCaseStereotypes.STEREOTYPE_USECASE);
