 ...
 * entity.
 */
public class EthicalProfileTool extends ElementTool {
	...
	String name = I18nMessageService.getString("Names.EthicalProfile");
	return DiagramUtils.getInstance().createClass(adaptElement(element), session, name,
		RCaseStereotypes.STEREOTYPE_ETHICAL_PROFILE);
    }
