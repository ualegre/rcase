 ...
 */
public class HurtTool extends RelationTool {
    ...
    public Dependency createDependency(ModelElement originElement, ModelElement targetElement) {
    	...
    	return (Dependency) ElementUtils.getInstance().addStereotype(RCasePeerModule.MODULE_NAME, dependency, RCaseStereotypes.STEREOTYPE_HURT);
    }
