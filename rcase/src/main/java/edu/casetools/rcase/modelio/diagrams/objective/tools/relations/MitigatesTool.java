 ...
 */
public class MitigatesTool extends RelationTool {
	...
	return acceptElement(RCasePeerModule.MODULE_NAME, target, RCaseStereotypes.STEREOTYPE_OBSTACLE);
    }
	...
	return ElementUtils.getInstance().createDependency(RCaseModule.getInstance(), RCasePeerModule.MODULE_NAME, originElement, targetElement,
		RCaseStereotypes.STEREOTYPE_MITIGATES);
    }
